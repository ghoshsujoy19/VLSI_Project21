...
`define AESL_MEM_Key_4 AESL_automem_Key_4
`define AESL_MEM_INST_Key_4 mem_inst_Key_4
`define AESL_MEM_Key_5 AESL_automem_Key_5
`define AESL_MEM_INST_Key_5 mem_inst_Key_5
`define AESL_MEM_Key_6 AESL_automem_Key_6
`define AESL_MEM_INST_Key_6 mem_inst_Key_6
`define AESL_MEM_Key_7 AESL_automem_Key_7
`define AESL_MEM_INST_Key_7 mem_inst_Key_7
...
`define AUTOTB_TVIN_RoundKey_4  "./c.KeyExpansion.autotvin_RoundKey_4.dat"
`define AUTOTB_TVIN_RoundKey_5  "./c.KeyExpansion.autotvin_RoundKey_5.dat"
`define AUTOTB_TVIN_RoundKey_6  "./c.KeyExpansion.autotvin_RoundKey_6.dat"
`define AUTOTB_TVIN_RoundKey_7  "./c.KeyExpansion.autotvin_RoundKey_7.dat"
...
`define AUTOTB_TVIN_Key_4  "./c.KeyExpansion.autotvin_Key_4.dat"
`define AUTOTB_TVIN_Key_5  "./c.KeyExpansion.autotvin_Key_5.dat"
`define AUTOTB_TVIN_Key_6  "./c.KeyExpansion.autotvin_Key_6.dat"
`define AUTOTB_TVIN_Key_7  "./c.KeyExpansion.autotvin_Key_7.dat"
...
`define AUTOTB_TVIN_RoundKey_4_out_wrapc  "./rtl.KeyExpansion.autotvin_RoundKey_4.dat"
`define AUTOTB_TVIN_RoundKey_5_out_wrapc  "./rtl.KeyExpansion.autotvin_RoundKey_5.dat"
`define AUTOTB_TVIN_RoundKey_6_out_wrapc  "./rtl.KeyExpansion.autotvin_RoundKey_6.dat"
`define AUTOTB_TVIN_RoundKey_7_out_wrapc  "./rtl.KeyExpansion.autotvin_RoundKey_7.dat"
...
`define AUTOTB_TVIN_Key_4_out_wrapc  "./rtl.KeyExpansion.autotvin_Key_4.dat"
`define AUTOTB_TVIN_Key_5_out_wrapc  "./rtl.KeyExpansion.autotvin_Key_5.dat"
`define AUTOTB_TVIN_Key_6_out_wrapc  "./rtl.KeyExpansion.autotvin_Key_6.dat"
`define AUTOTB_TVIN_Key_7_out_wrapc  "./rtl.KeyExpansion.autotvin_Key_7.dat"
...
`define AUTOTB_TVOUT_RoundKey_4  "./c.KeyExpansion.autotvout_RoundKey_4.dat"
`define AUTOTB_TVOUT_RoundKey_5  "./c.KeyExpansion.autotvout_RoundKey_5.dat"
`define AUTOTB_TVOUT_RoundKey_6  "./c.KeyExpansion.autotvout_RoundKey_6.dat"
`define AUTOTB_TVOUT_RoundKey_7  "./c.KeyExpansion.autotvout_RoundKey_7.dat"
...
`define AUTOTB_TVOUT_RoundKey_4_out_wrapc  "./impl_rtl.KeyExpansion.autotvout_RoundKey_4.dat"
`define AUTOTB_TVOUT_RoundKey_5_out_wrapc  "./impl_rtl.KeyExpansion.autotvout_RoundKey_5.dat"
`define AUTOTB_TVOUT_RoundKey_6_out_wrapc  "./impl_rtl.KeyExpansion.autotvout_RoundKey_6.dat"
`define AUTOTB_TVOUT_RoundKey_7_out_wrapc  "./impl_rtl.KeyExpansion.autotvout_RoundKey_7.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_RoundKey_3 = 30;
parameter LENGTH_RoundKey_4 = 30;
parameter LENGTH_RoundKey_5 = 30;
parameter LENGTH_RoundKey_6 = 30;
parameter LENGTH_RoundKey_7 = 30;
parameter LENGTH_Key_0 = 2;
parameter LENGTH_Key_1 = 2;
parameter LENGTH_Key_2 = 2;
parameter LENGTH_Key_3 = 2;
parameter LENGTH_Key_4 = 2;
parameter LENGTH_Key_5 = 2;
parameter LENGTH_Key_6 = 2;
parameter LENGTH_Key_7 = 2;
...
wire ap_idle;
wire ap_ready;
wire [4 : 0] RoundKey_0_address0;
wire  RoundKey_0_ce0;
wire  RoundKey_0_we0;
wire [7 : 0] RoundKey_0_d0;
wire [7 : 0] RoundKey_0_q0;
wire [4 : 0] RoundKey_0_address1;
wire  RoundKey_0_ce1;
wire  RoundKey_0_we1;
...
wire [4 : 0] RoundKey_4_address1;
wire  RoundKey_4_ce1;
wire  RoundKey_4_we1;
wire [7 : 0] RoundKey_4_d1;
wire [4 : 0] RoundKey_5_address0;
wire  RoundKey_5_ce0;
wire  RoundKey_5_we0;
wire [7 : 0] RoundKey_5_d0;
wire [7 : 0] RoundKey_5_q0;
wire [4 : 0] RoundKey_5_address1;
wire  RoundKey_5_ce1;
wire  RoundKey_5_we1;
wire [7 : 0] RoundKey_5_d1;
wire [4 : 0] RoundKey_6_address0;
wire  RoundKey_6_ce0;
wire  RoundKey_6_we0;
wire [7 : 0] RoundKey_6_d0;
wire [7 : 0] RoundKey_6_q0;
wire [4 : 0] RoundKey_6_address1;
wire  RoundKey_6_ce1;
wire  RoundKey_6_we1;
...
wire  Key_0_ce0;
wire [7 : 0] Key_0_q0;
wire [0 : 0] Key_0_address1;
wire  Key_0_ce1;
wire [7 : 0] Key_0_q1;
wire [0 : 0] Key_1_address0;
wire  Key_1_ce0;
wire [7 : 0] Key_1_q0;
wire [0 : 0] Key_1_address1;
wire  Key_1_ce1;
wire [7 : 0] Key_1_q1;
wire [0 : 0] Key_2_address0;
wire  Key_2_ce0;
wire [7 : 0] Key_2_q0;
wire [0 : 0] Key_2_address1;
wire  Key_2_ce1;
wire [7 : 0] Key_2_q1;
wire [0 : 0] Key_3_address0;
wire  Key_3_ce0;
wire [7 : 0] Key_3_q0;
wire [0 : 0] Key_3_address1;
wire  Key_3_ce1;
wire [7 : 0] Key_3_q1;
wire [0 : 0] Key_4_address0;
wire  Key_4_ce0;
wire [7 : 0] Key_4_q0;
wire [0 : 0] Key_4_address1;
wire  Key_4_ce1;
wire [7 : 0] Key_4_q1;
wire [0 : 0] Key_5_address0;
wire  Key_5_ce0;
wire [7 : 0] Key_5_q0;
wire [0 : 0] Key_5_address1;
wire  Key_5_ce1;
wire [7 : 0] Key_5_q1;
wire [0 : 0] Key_6_address0;
wire  Key_6_ce0;
wire [7 : 0] Key_6_q0;
wire [0 : 0] Key_6_address1;
wire  Key_6_ce1;
wire [7 : 0] Key_6_q1;
wire [0 : 0] Key_7_address0;
wire  Key_7_ce0;
wire [7 : 0] Key_7_q0;
wire [0 : 0] Key_7_address1;
wire  Key_7_ce1;
wire [7 : 0] Key_7_q1;
integer done_cnt = 0;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .RoundKey_4_address1(RoundKey_4_address1),
    .RoundKey_4_ce1(RoundKey_4_ce1),
    .RoundKey_4_we1(RoundKey_4_we1),
    .RoundKey_4_d1(RoundKey_4_d1),
    ...
    .RoundKey_5_address1(RoundKey_5_address1),
    .RoundKey_5_ce1(RoundKey_5_ce1),
    .RoundKey_5_we1(RoundKey_5_we1),
    .RoundKey_5_d1(RoundKey_5_d1),
    ...
    .RoundKey_6_address1(RoundKey_6_address1),
    ...
    .RoundKey_7_address1(RoundKey_7_address1),
    ...
    .Key_3_ce1(Key_3_ce1),
    .Key_3_q1(Key_3_q1),
    .Key_4_address0(Key_4_address0),
    .Key_4_ce0(Key_4_ce0),
    .Key_4_q0(Key_4_q0),
    .Key_4_address1(Key_4_address1),
    .Key_4_ce1(Key_4_ce1),
    .Key_4_q1(Key_4_q1),
    .Key_5_address0(Key_5_address0),
    .Key_5_ce0(Key_5_ce0),
    .Key_5_q0(Key_5_q0),
    .Key_5_address1(Key_5_address1),
    .Key_5_ce1(Key_5_ce1),
    .Key_5_q1(Key_5_q1),
    .Key_6_address0(Key_6_address0),
    .Key_6_ce0(Key_6_ce0),
    .Key_6_q0(Key_6_q0),
    .Key_6_address1(Key_6_address1),
    .Key_6_ce1(Key_6_ce1),
    .Key_6_q1(Key_6_q1),
    .Key_7_address0(Key_7_address0),
    .Key_7_ce0(Key_7_ce0),
    .Key_7_q0(Key_7_q0),
    .Key_7_address1(Key_7_address1),
    .Key_7_ce1(Key_7_ce1),
    .Key_7_q1(Key_7_q1));
...
wire    [4 : 0]    arrayRoundKey_0_address0, arrayRoundKey_0_address1;
...
wire    [4 : 0]    arrayRoundKey_1_address0, arrayRoundKey_1_address1;
...
wire    [4 : 0]    arrayRoundKey_2_address0, arrayRoundKey_2_address1;
...
wire    [4 : 0]    arrayRoundKey_3_address0, arrayRoundKey_3_address1;
...
wire    [4 : 0]    arrayRoundKey_4_address0, arrayRoundKey_4_address1;
...
assign arrayRoundKey_4_address1 = RoundKey_4_address1;
assign arrayRoundKey_4_ce1 = RoundKey_4_ce1;
assign arrayRoundKey_4_we1 = RoundKey_4_we1;
assign arrayRoundKey_4_din1 = RoundKey_4_d1;
...
wire    [4 : 0]    arrayRoundKey_5_address0, arrayRoundKey_5_address1;
...
assign arrayRoundKey_5_address1 = RoundKey_5_address1;
assign arrayRoundKey_5_ce1 = RoundKey_5_ce1;
assign arrayRoundKey_5_we1 = RoundKey_5_we1;
assign arrayRoundKey_5_din1 = RoundKey_5_d1;
...
wire    [4 : 0]    arrayRoundKey_6_address0, arrayRoundKey_6_address1;
...
wire    [4 : 0]    arrayRoundKey_7_address0, arrayRoundKey_7_address1;
...
wire    [0 : 0]    arrayKey_0_address0, arrayKey_0_address1;
...
wire    [0 : 0]    arrayKey_1_address0, arrayKey_1_address1;
...
wire    [0 : 0]    arrayKey_2_address0, arrayKey_2_address1;
...
wire    [0 : 0]    arrayKey_3_address0, arrayKey_3_address1;
...
//------------------------arrayKey_4 Instantiation--------------

// The input and output of arrayKey_4
wire    arrayKey_4_ce0, arrayKey_4_ce1;
wire    arrayKey_4_we0, arrayKey_4_we1;
wire    [0 : 0]    arrayKey_4_address0, arrayKey_4_address1;
wire    [7 : 0]    arrayKey_4_din0, arrayKey_4_din1;
wire    [7 : 0]    arrayKey_4_dout0, arrayKey_4_dout1;
wire    arrayKey_4_ready;
wire    arrayKey_4_done;

`AESL_MEM_Key_4 `AESL_MEM_INST_Key_4(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayKey_4_ce0),
    .we0        (arrayKey_4_we0),
    .address0   (arrayKey_4_address0),
    .din0       (arrayKey_4_din0),
    .dout0      (arrayKey_4_dout0),
    .ce1        (arrayKey_4_ce1),
    .we1        (arrayKey_4_we1),
    .address1   (arrayKey_4_address1),
    .din1       (arrayKey_4_din1),
    .dout1      (arrayKey_4_dout1),
    .ready      (arrayKey_4_ready),
    .done    (arrayKey_4_done)
);

// Assignment between dut and arrayKey_4
assign arrayKey_4_address0 = Key_4_address0;
assign arrayKey_4_ce0 = Key_4_ce0;
assign Key_4_q0 = arrayKey_4_dout0;
assign arrayKey_4_we0 = 0;
assign arrayKey_4_din0 = 0;
assign arrayKey_4_address1 = Key_4_address1;
assign arrayKey_4_ce1 = Key_4_ce1;
assign Key_4_q1 = arrayKey_4_dout1;
assign arrayKey_4_we1 = 0;
assign arrayKey_4_din1 = 0;
assign arrayKey_4_ready=    ready;
assign arrayKey_4_done = 0;


//------------------------arrayKey_5 Instantiation--------------

// The input and output of arrayKey_5
wire    arrayKey_5_ce0, arrayKey_5_ce1;
wire    arrayKey_5_we0, arrayKey_5_we1;
wire    [0 : 0]    arrayKey_5_address0, arrayKey_5_address1;
wire    [7 : 0]    arrayKey_5_din0, arrayKey_5_din1;
wire    [7 : 0]    arrayKey_5_dout0, arrayKey_5_dout1;
wire    arrayKey_5_ready;
wire    arrayKey_5_done;

`AESL_MEM_Key_5 `AESL_MEM_INST_Key_5(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayKey_5_ce0),
    .we0        (arrayKey_5_we0),
    .address0   (arrayKey_5_address0),
    .din0       (arrayKey_5_din0),
    .dout0      (arrayKey_5_dout0),
    .ce1        (arrayKey_5_ce1),
    .we1        (arrayKey_5_we1),
    .address1   (arrayKey_5_address1),
    .din1       (arrayKey_5_din1),
    .dout1      (arrayKey_5_dout1),
    .ready      (arrayKey_5_ready),
    .done    (arrayKey_5_done)
);

// Assignment between dut and arrayKey_5
assign arrayKey_5_address0 = Key_5_address0;
assign arrayKey_5_ce0 = Key_5_ce0;
assign Key_5_q0 = arrayKey_5_dout0;
assign arrayKey_5_we0 = 0;
assign arrayKey_5_din0 = 0;
assign arrayKey_5_address1 = Key_5_address1;
assign arrayKey_5_ce1 = Key_5_ce1;
assign Key_5_q1 = arrayKey_5_dout1;
assign arrayKey_5_we1 = 0;
assign arrayKey_5_din1 = 0;
assign arrayKey_5_ready=    ready;
assign arrayKey_5_done = 0;


//------------------------arrayKey_6 Instantiation--------------

// The input and output of arrayKey_6
wire    arrayKey_6_ce0, arrayKey_6_ce1;
wire    arrayKey_6_we0, arrayKey_6_we1;
wire    [0 : 0]    arrayKey_6_address0, arrayKey_6_address1;
wire    [7 : 0]    arrayKey_6_din0, arrayKey_6_din1;
wire    [7 : 0]    arrayKey_6_dout0, arrayKey_6_dout1;
wire    arrayKey_6_ready;
wire    arrayKey_6_done;

`AESL_MEM_Key_6 `AESL_MEM_INST_Key_6(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayKey_6_ce0),
    .we0        (arrayKey_6_we0),
    .address0   (arrayKey_6_address0),
    .din0       (arrayKey_6_din0),
    .dout0      (arrayKey_6_dout0),
    .ce1        (arrayKey_6_ce1),
    .we1        (arrayKey_6_we1),
    .address1   (arrayKey_6_address1),
    .din1       (arrayKey_6_din1),
    .dout1      (arrayKey_6_dout1),
    .ready      (arrayKey_6_ready),
    .done    (arrayKey_6_done)
);

// Assignment between dut and arrayKey_6
assign arrayKey_6_address0 = Key_6_address0;
assign arrayKey_6_ce0 = Key_6_ce0;
assign Key_6_q0 = arrayKey_6_dout0;
assign arrayKey_6_we0 = 0;
assign arrayKey_6_din0 = 0;
assign arrayKey_6_address1 = Key_6_address1;
assign arrayKey_6_ce1 = Key_6_ce1;
assign Key_6_q1 = arrayKey_6_dout1;
assign arrayKey_6_we1 = 0;
assign arrayKey_6_din1 = 0;
assign arrayKey_6_ready=    ready;
assign arrayKey_6_done = 0;


//------------------------arrayKey_7 Instantiation--------------

// The input and output of arrayKey_7
wire    arrayKey_7_ce0, arrayKey_7_ce1;
wire    arrayKey_7_we0, arrayKey_7_we1;
wire    [0 : 0]    arrayKey_7_address0, arrayKey_7_address1;
wire    [7 : 0]    arrayKey_7_din0, arrayKey_7_din1;
wire    [7 : 0]    arrayKey_7_dout0, arrayKey_7_dout1;
wire    arrayKey_7_ready;
wire    arrayKey_7_done;

`AESL_MEM_Key_7 `AESL_MEM_INST_Key_7(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayKey_7_ce0),
    .we0        (arrayKey_7_we0),
    .address0   (arrayKey_7_address0),
    .din0       (arrayKey_7_din0),
    .dout0      (arrayKey_7_dout0),
    .ce1        (arrayKey_7_ce1),
    .we1        (arrayKey_7_we1),
    .address1   (arrayKey_7_address1),
    .din1       (arrayKey_7_din1),
    .dout1      (arrayKey_7_dout1),
    .ready      (arrayKey_7_ready),
    .done    (arrayKey_7_done)
);

// Assignment between dut and arrayKey_7
assign arrayKey_7_address0 = Key_7_address0;
assign arrayKey_7_ce0 = Key_7_ce0;
assign Key_7_q0 = arrayKey_7_dout0;
assign arrayKey_7_we0 = 0;
assign arrayKey_7_din0 = 0;
assign arrayKey_7_address1 = Key_7_address1;
assign arrayKey_7_ce1 = Key_7_ce1;
assign Key_7_q1 = arrayKey_7_dout1;
assign arrayKey_7_we1 = 0;
assign arrayKey_7_din1 = 0;
assign arrayKey_7_ready=    ready;
assign arrayKey_7_done = 0;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.KeyExpansion.autotvout_RoundKey_4.dat", "r");
    fp2 = $fopen("./impl_rtl.KeyExpansion.autotvout_RoundKey_4.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.KeyExpansion.autotvout_RoundKey_4.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.KeyExpansion.autotvout_RoundKey_4.dat\"!");
    else begin
        $display("Comparing rtl.KeyExpansion.autotvout_RoundKey_4.dat with impl_rtl.KeyExpansion.autotvout_RoundKey_4.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.KeyExpansion.autotvout_RoundKey_5.dat", "r");
    fp2 = $fopen("./impl_rtl.KeyExpansion.autotvout_RoundKey_5.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.KeyExpansion.autotvout_RoundKey_5.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.KeyExpansion.autotvout_RoundKey_5.dat\"!");
    else begin
        $display("Comparing rtl.KeyExpansion.autotvout_RoundKey_5.dat with impl_rtl.KeyExpansion.autotvout_RoundKey_5.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.KeyExpansion.autotvout_RoundKey_6.dat", "r");
    fp2 = $fopen("./impl_rtl.KeyExpansion.autotvout_RoundKey_6.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.KeyExpansion.autotvout_RoundKey_6.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.KeyExpansion.autotvout_RoundKey_6.dat\"!");
    else begin
        $display("Comparing rtl.KeyExpansion.autotvout_RoundKey_6.dat with impl_rtl.KeyExpansion.autotvout_RoundKey_6.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.KeyExpansion.autotvout_RoundKey_7.dat", "r");
    fp2 = $fopen("./impl_rtl.KeyExpansion.autotvout_RoundKey_7.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.KeyExpansion.autotvout_RoundKey_7.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.KeyExpansion.autotvout_RoundKey_7.dat\"!");
    else begin
        $display("Comparing rtl.KeyExpansion.autotvout_RoundKey_7.dat with impl_rtl.KeyExpansion.autotvout_RoundKey_7.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
