...
`define AUTOTB_TVIN_RoundKey  "./c.KeyExpansion.autotvin_RoundKey.dat"
`define AUTOTB_TVIN_Key  "./c.KeyExpansion.autotvin_Key.dat"
`define AUTOTB_TVIN_RoundKey_out_wrapc  "./rtl.KeyExpansion.autotvin_RoundKey.dat"
`define AUTOTB_TVIN_Key_out_wrapc  "./rtl.KeyExpansion.autotvin_Key.dat"
`define AUTOTB_TVOUT_RoundKey  "./c.KeyExpansion.autotvout_RoundKey.dat"
`define AUTOTB_TVOUT_RoundKey_out_wrapc  "./impl_rtl.KeyExpansion.autotvout_RoundKey.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.KeyExpansion.autotvout_RoundKey.dat", "r");
    fp2 = $fopen("./impl_rtl.KeyExpansion.autotvout_RoundKey.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.KeyExpansion.autotvout_RoundKey.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.KeyExpansion.autotvout_RoundKey.dat\"!");
    else begin
        $display("Comparing rtl.KeyExpansion.autotvout_RoundKey.dat with impl_rtl.KeyExpansion.autotvout_RoundKey.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
