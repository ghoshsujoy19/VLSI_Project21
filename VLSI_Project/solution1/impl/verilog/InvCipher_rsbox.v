...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module InvCipher_rsbox_rom (
...
initial begin
    $readmemh("./InvCipher_rsbox_rom.dat", ram0);
    $readmemh("./InvCipher_rsbox_rom.dat", ram1);
    $readmemh("./InvCipher_rsbox_rom.dat", ram2);
    $readmemh("./InvCipher_rsbox_rom.dat", ram3);
    $readmemh("./InvCipher_rsbox_rom.dat", ram4);
    $readmemh("./InvCipher_rsbox_rom.dat", ram5);
    $readmemh("./InvCipher_rsbox_rom.dat", ram6);
    $readmemh("./InvCipher_rsbox_rom.dat", ram7);
end
...
InvCipher_rsbox_rom InvCipher_rsbox_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
