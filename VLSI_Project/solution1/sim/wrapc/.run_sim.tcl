...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "InvCipher.autotvin.dat"
	set constFileTvOut       "InvCipher.autotvout.dat"
	set constFileHdlTvIn     "InvCipher.autohdltvin.dat"
	set constFileHdlTvOut    "InvCipher.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
