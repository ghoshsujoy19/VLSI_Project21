...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "KeyExpansion.autotvin.dat"
	set constFileTvOut       "KeyExpansion.autotvout.dat"
	set constFileHdlTvIn     "KeyExpansion.autohdltvin.dat"
	set constFileHdlTvOut    "KeyExpansion.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
