...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AES.autotvin.dat"
	set constFileTvOut       "AES.autotvout.dat"
	set constFileHdlTvIn     "AES.autohdltvin.dat"
	set constFileHdlTvOut    "AES.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
