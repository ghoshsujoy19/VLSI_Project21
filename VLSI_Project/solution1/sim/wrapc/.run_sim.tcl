...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Cipher.autotvin.dat"
	set constFileTvOut       "Cipher.autotvout.dat"
	set constFileHdlTvIn     "Cipher.autohdltvin.dat"
	set constFileHdlTvOut    "Cipher.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
