...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module Cipher_sbox_7_rom (
...
initial begin
    $readmemh("./Cipher_sbox_7_rom.dat", ram0);
    $readmemh("./Cipher_sbox_7_rom.dat", ram1);
end
...
Cipher_sbox_7_rom Cipher_sbox_7_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
