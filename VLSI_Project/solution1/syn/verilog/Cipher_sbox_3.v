...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module Cipher_sbox_3_rom (
...
initial begin
    $readmemh("./Cipher_sbox_3_rom.dat", ram0);
    $readmemh("./Cipher_sbox_3_rom.dat", ram1);
end
...
Cipher_sbox_3_rom Cipher_sbox_3_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
