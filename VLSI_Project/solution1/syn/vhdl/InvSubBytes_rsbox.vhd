...
entity InvSubBytes_rsbox_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of InvSubBytes_rsbox_rom is 
...
architecture arch of InvSubBytes_rsbox is
    component InvSubBytes_rsbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    InvSubBytes_rsbox_rom_U :  component InvSubBytes_rsbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
