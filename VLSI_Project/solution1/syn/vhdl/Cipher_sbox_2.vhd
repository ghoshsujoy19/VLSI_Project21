...
architecture rtl of Cipher_sbox_2_rom is 
...
architecture arch of Cipher_sbox_2 is
    component Cipher_sbox_2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Cipher_sbox_2_rom_U :  component Cipher_sbox_2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
