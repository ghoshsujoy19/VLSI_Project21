...
// ==============================================================
#ifndef __InvCipher_rsbox_H__
#define __InvCipher_rsbox_H__
...
struct InvCipher_rsbox_ram : public sc_core::sc_module {
...
InvCipher_rsbox_ram* meminst;


SC_CTOR(InvCipher_rsbox) {
meminst = new InvCipher_rsbox_ram("InvCipher_rsbox_ram");
